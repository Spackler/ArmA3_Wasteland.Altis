...
private [ "_box1", "_barGate", "_bunker1", "_bunker2", "_obj1", "_obj2", "_drop_item","_cashamountrandomizer", "_cashpilerandomizer", "_cash", "_cashamount", "_cashpile", "_cash1"];
...
_setupObjects =
{
	...
	_missionHintText = format ["Armed bandits have set up a <t color='%1'>Roadblock</t> and are stopping all vehicles! Stop them and retrieve any money!", moneyMissionColor]
};
...
_successExec =
{
	...
	_successHintMessage = format ["The roadblock has been captured. The money is all yours!"];
};
